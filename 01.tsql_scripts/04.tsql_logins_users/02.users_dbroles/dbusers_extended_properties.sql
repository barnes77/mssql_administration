...
Aim: Gather information about all extended properties of db users
*/
USE tempdb;
SET NOCOUNT ON;
...
WHERE 1=1
	AND class_desc = 'DATABASE_PRINCIPAL'
--	AND [name] = ''
--	AND [name] LIKE '%%'
...
/*
--query to add property to a user
USE [database]
exec sp_addextendedproperty @name='PROPERTY_NAME',@value='PROPERTY_VALUE', @level0type = 'USER', @level0name = 'DB_USER_NAME'
*/
