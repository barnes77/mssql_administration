...
WHERE 1=1
	AND smf.[type] = 1 
	AND CAST(dfi.free_space_mb*100/dfi.size_mb AS decimal(20,2)) IS NOT NULL 
	AND CAST(dfi.free_space_mb*100/dfi.size_mb AS decimal(20,2)) < 20.00
	--AND sdb.[name] NOT LIKE '%Dummy%' AND sdb.[name] NOT IN ('DBA','magic')
